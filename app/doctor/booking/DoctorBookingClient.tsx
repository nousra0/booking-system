...
export default function DoctorBookingClient({
  ...
  const doctorFromQuery = searchParams.doctor || "";

  const initialPatientName = isEditMode ? searchParams.patientName || "" : "";
  const initialPhone = isEditMode ? searchParams.phone || "" : "";
  const initialDoctor = doctorFromQuery;
  const initialDate = isEditMode ? searchParams.date || "" : "";
  const initialTime = isEditMode ? searchParams.time || "" : "";
  const initialReason = isEditMode ? searchParams.reason || "" : "";
